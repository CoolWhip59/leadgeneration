...
const businesses_dto_1 = require("./businesses.dto");
...
__decorate([
    ...
    __metadata("design:paramtypes", [businesses_dto_1.BusinessQueryDto]),
    __metadata("design:returntype", void 0)
], BusinessesController.prototype, "list", null);
__decorate([
    (0, common_1.Get)('export'),
    (0, common_1.Header)('Content-Type', 'text/csv'),
    (0, common_1.Header)('Content-Disposition', 'attachment; filename="businesses.csv"'),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [businesses_dto_1.BusinessQueryDto]),
    __metadata("design:returntype", Promise)
], BusinessesController.prototype, "export", null);
